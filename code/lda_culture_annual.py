...
def ldaModel(numWords,num_topics):
    ...
    mat = np.loadtxt(open("/home/mcorrito/projects/def-mcorrito/mcorrito/HH/data/top_unigrams_phrase_4000_pruned.csv", "rb"), delimiter=",")
    ...
    # df.read_pickle('/home/mcorrito/projects/def-mcorrito/mcorrito/HH/data/' + 'top_unigrams_' + str(numWords) + '_annual.pkl')
